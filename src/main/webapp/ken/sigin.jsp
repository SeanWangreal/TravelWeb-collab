...
<link rel="stylesheet" href="../ken_dlist/css/comp_mem.css">
<style>
</style>
</head>
			...
			<div class="row h-100 align-items-center justify-content-center"
				...
				<div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
					<div class>
						...
						<a href='com_mem.jsp'>List</a> all company.  <br><br>

						<FORM METHOD="post"
							ACTION="<%=request.getContextPath()%>/CompanyServlet"
							style="margin-bottom: 0px;">
							<input type="submit" value="修改"> <input type="hidden"
								name="compId" value="${company.compId}"> <input
