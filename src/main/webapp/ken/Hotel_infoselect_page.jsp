...
<html>
<head>
<title>IBM Hotel_info: Home</title>
...
<ul>
  <li><a href='listAllHotelinfo.jsp'>List</a> all consumers.  <br><br></li>
  
  
  <li>
    <FORM METHOD="post" ACTION="/Hotel_infoServlet" >
        <b>輸入會員編號 (如7001):</b>
        <input type="text" name="hotelInfoId">
     ...
     <FORM METHOD="post" ACTION="/Hotel_infoServlet" >
       ...
       <select size="1" name="hotelInfoId">
         <c:forEach var="hotelInfo" items="${hotelInfoSvc.all}" > 
          <option value="${hotelInfo.hotelInfoId}">${hotelInfo.hotelInfoId}
         </c:forEach>   
       </select>
...
<ul>
  <li><a href='addHotel_info.jsp'>Add</a> a new Hotel_info.</li>
</ul>
