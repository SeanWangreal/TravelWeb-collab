...
<body>
    ...
    <div class="all">
        <main class="main-content">
            <form class="main-content-info">
                <label class="">舊密碼 :&ensp;<input type="text"></label>
                <br>
                <label class="">新密碼 :&ensp;<input type="text" id="new_p"></label>
                <br>
                <label class="">確認新密碼 :&ensp;<input type="text" id="check"></label>
                <div>
