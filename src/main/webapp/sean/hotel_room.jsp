				...
				<c:if test="${not empty room}">
					<section class="one-room">
						...
						<div class="alert_bg">
							<div class="alert">
								<div>
									確定刪除嗎? <br> <a class="other-btn" id="yes"
										href="${pageContext.request.contextPath}/sean/RoomServlet?action=delete1&id=${room.roomId}">Yes</a>
									<button type="button" class="other-btn" id="no">No</button>
								</div>
							</div>
						</div>
					</section>
