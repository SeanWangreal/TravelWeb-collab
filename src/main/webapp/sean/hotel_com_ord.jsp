    ...
    <div class="all">
        <main class="main-content">
            <div class="main-content-info">
                ...
                <div class="ord">
                    <div>
                        <label class="ord-head">訂單編號:<span name="ord_id">21214</span></label>
                        <label class="ord-head">房間名稱:<span name="room_name">總統套房</span></label>
                    </div>
                    <div class="all-info">
                        <div>
                            <label for="" class="l_long ord-label">房型<br><span class="long" name="room_type">333</span></label>
                            <label for="" class="l_long ord-label">房數<br><span class="long" name="room_num">333</span></label>
                            <label for="" class="l_long ord-label">總金額<br><span class="long" name="total_money">9213071346222</span><span>元</span></label>
                            <label for="" class="l_long ord-label">顧客名稱<br><span class="long" name="customer_name">333</span></label>
                            <label for="" class="l_long ord-label">入住日期<br><span class="long" name="check_in">333</span></label>
                            <label for="" class="l_long ord-label">退房日期<br><span class="long" name="check_out">333</span></label>
                        </div>
                        <div class="remark-block">
                            <label for="" class="remark">備註:</label>
                            <p class="remark-info" name="remark">我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我我
                            </p>
                        </div>
                    </div>
                </div>
