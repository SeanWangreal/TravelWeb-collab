...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/eric_css/ordinf.css">
		...
		<main class="main-content">
			<div class="main-content-info">
				...
				<div class="memBtn" id="memBtn"
					...
					<a
						href="${pageContext.request.contextPath}/eric/ConsumerServlet?action=getOne_For_Update">編輯</a>
				</div>
				<br>
				<div class="mem_detal">
